...
#### Adicionalmente, super importante tener en cuenta que si el cliente decide adquirir esta solución, puede obtener un descuento del 80% o más, dependiendo del tiempo de reserva de los recursos que se vayan a desplegar.
